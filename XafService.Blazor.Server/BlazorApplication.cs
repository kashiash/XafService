...
namespace XafService.Blazor.Server {
    public partial class XafServiceBlazorApplication : BlazorApplication {
        public XafServiceBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafServiceBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
